...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[0] = LAYOUT(KC_Q, KC_W, KC_F, KC_P, KC_B, KC_J, KC_L, KC_U, KC_Y, KC_BSPC, KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_Z, LT(0, KC_X), LT(0, KC_C), KC_D, LT(0, KC_V), KC_K, KC_H, LT(0, KC_LBRC), LT(0, KC_RBRC), KC_SLSH, LSFT_T(KC_ENT), KC_SPC, OPT_T(KC_COMM), LT(1, KC_DOT)),
                                                              ...
                                                              [2] = LAYOUT(KC_ESC, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, MKR_QUOTE, MKR_CURLY, KC_TRNS, KC_TRNS, TG(2), KC_TAB, KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, MKR_ARROW, MKR_ARROW_FN, KC_GRV, KC_SLSH, TG(3), KC_DEL, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, MKR_BRACKET, MKR_ARRAY, KC_COMM, KC_DOT, TG(4), LSFT_T(KC_ENT), KC_SPC, LT(0, KC_NO), TO(0)),
                                                              [3] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, RGB_TOG, KC_BRID, KC_BRIU, KC_VOLD, KC_VOLU, TO(2), KC_F5, KC_F6, KC_F7, KC_F8, RGB_VAI, KC_INS, KC_HOME, KC_PGUP, KC_NO, TG(3), KC_F9, KC_F10, KC_F11, KC_F12, RGB_VAD, KC_DEL, KC_END, KC_PGDN, KC_NO, TG(4), LSFT_T(KC_ENT), KC_SPC, LT(0, KC_NO), TO(0)),
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    uint8_t h_index[5][255] = {{33, 41, 42, 43}, {8, 9, 10, 13, 14, 15, 17, 18, 19, 20, 33, 38, 43}, {7, 8, 9, 10, 29, 30, 33, 34, 35, 38, 39, 40, 43}, {29, 30, 31, 32, 33, 38, 43}, {38}};
    ...
    for (uint8_t i = led_min; i < led_max; i++) {
        if (i < 6 || (i > 22 && i < 29)) {
            ...
            if (isInArr(h_index[curr_layer], h_sizes[curr_layer], i)) {
                // special highlighted cases
                rgb_matrix_set_color(i, min(g + 30, 255), min(b + 30, 255), min(r + 30, 255));
            } else {
                rgb_matrix_set_color(i, min(r + 30, 255), min(g + 30, 255), min(b + 30, 255));
            }
        }
    }
    return false;
